...
void discharge_patient(patient *, patient *, int *, int *, int *);
    ...
    while(option != 6) {
        ...
        case 2: // Admit new patient
            if(used_beds == 0) {
                ...
                *s_id = 0;
                admit_patient(hospital, total_patients, n_patients, bid_ptr, u_beds, a_beds, t_beds, s_id);
            } else {
            ...
            break;
        case 3: 
            discharge_patient(hospital, total_patients, u_beds, a_beds, s_id);
            break;   
        case 4:
...
void discharge_patient(patient * hospital, patient * total_patients, int * used_beds, int * available_beds, int * save_id) {
    patient * p;
    int discharge;
    int available_id;

/*
    ...
    Instrucciones: Aplicación para llevar el control de pacientes en un hospital.
        Características:
            - De cada paciente se sabe su nombre, apellidos, edad, teléfono y la cama signada
            - Inicialmente el hospital cuenta con un númeo de camas fijas, pero se pueden incorporar más
            - El ID de las camas es un número consecutivo
            - Añadir más camas de 5 en 5
        El programa debe
            - Conocer qué paciente se encuentra asignado a una cama dada o si ésta se encuentra disponible
            - Dar de alta un paciente por el número de cama (se retira del hospital y la cama queda disponible)
            - Mostrar el listado de todos los pacientes, incluyendo el número de la cama asignada
            - Conocer el número de camas disponibles y número de camas ocupadas
*/
